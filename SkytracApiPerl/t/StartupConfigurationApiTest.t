...
use_ok('WWW::OpenAPIClient::StartupConfigurationApi');

my $api = WWW::OpenAPIClient::StartupConfigurationApi->new();
isa_ok($api, 'WWW::OpenAPIClient::StartupConfigurationApi');

#
# cfg_startup_patch test
#
# uncomment below and update the test
#my $cfg_startup_patch_configuration_request = undef; # replace NULL with a proper value
#my $cfg_startup_patch_result = $api->cfg_startup_patch(configuration_request => $cfg_startup_patch_configuration_request);
