...
typedef enum { quicksilver_web_api_ird_state__NULL = 0, quicksilver_web_api_ird_state__available, quicksilver_web_api_ird_state__busy, quicksilver_web_api_ird_state__faulty, quicksilver_web_api_ird_state__recovery mode, quicksilver_web_api_ird_state__unsupported api } quicksilver_web_api_ird_state__e;
