...
NotificationsAPI_notificationsGet(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/notifications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/notifications");
...
NotificationsAPI_notificationsIdDelete(apiClient_t *apiClient, double id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/notifications/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/notifications/{id}");
