...
#
package WWW::OpenAPIClient::Object::DeviceFwUpdatePost200Response;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'DeviceFwUpdatePost200Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'status' => {
        datatype => 'string',
        base_name => 'status',
        description => 'The result / status of the update. - started - The update has started - partial - The update failed leaving partial changes - failed - The update failed leaving no changes - success - The update was successful ',
        format => '',
        read_only => '',
            },
    'error' => {
    ...
    'will_reboot' => {
        datatype => 'boolean',
        base_name => 'willReboot',
        description => 'Whether the update will reboot the device automatically when done. If false, then a reboot is not required.',
        format => '',
        read_only => '',
            },
});
