...
#
package WWW::OpenAPIClient::Object::DeviceFwLastUpdateResultGet200Response;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'DeviceFwLastUpdateResultGet200Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'error' => {
        datatype => 'string',
        base_name => 'error',
        description => 'Error message for failed updates. Blank if the update was successful. Partial updates result in the device entering recovery mode.',
        format => '',
        read_only => '',
            },
});
