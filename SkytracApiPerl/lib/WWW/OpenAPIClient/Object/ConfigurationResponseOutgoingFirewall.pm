...
#
package WWW::OpenAPIClient::Object::ConfigurationResponseOutgoingFirewall;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'ConfigurationResponseOutgoingFirewall',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'rules' => {
        datatype => 'ARRAY[OutgoingFirewallRule]',
        base_name => 'rules',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'rules' => 'ARRAY[OutgoingFirewallRule]'
} );
