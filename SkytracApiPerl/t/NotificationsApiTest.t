...
#
# notifications_get test
#
# uncomment below and update the test
#my $notifications_get_result = $api->notifications_get();

#
# notifications_id_delete test
#
# uncomment below and update the test
#my $notifications_id_delete_id = undef; # replace NULL with a proper value
#my $notifications_id_delete_result = $api->notifications_id_delete(id => $notifications_id_delete_id);
