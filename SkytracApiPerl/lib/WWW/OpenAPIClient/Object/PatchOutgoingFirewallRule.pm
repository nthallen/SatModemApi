...
#
package WWW::OpenAPIClient::Object::PatchOutgoingFirewallRule;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'PatchOutgoingFirewallRule',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'name' => {
        datatype => 'string',
        base_name => 'name',
        description => 'Unique display name. Must be 1-15 characters and only contain alphanumeric characters, &#39;_&#39;, &#39;-&#39;, &#39;.&#39;, and &#39;~&#39;. ',
        format => '',
        read_only => '',
            },
    'protocol' => {
...
__PACKAGE__->openapi_types( {
    ...
    'protocol' => 'string',
    'dest_addr' => 'string',
    'dest_addr_neg' => 'boolean',
    'dest_port' => 'string',
    'dest_port_neg' => 'boolean',
    'action' => 'string'
} );
...
__PACKAGE__->attribute_map( {
    ...
    'protocol' => 'protocol',
    'dest_addr' => 'destAddr',
    'dest_addr_neg' => 'destAddrNeg',
    'dest_port' => 'destPort',
    'dest_port_neg' => 'destPortNeg',
    'action' => 'action'
} );
