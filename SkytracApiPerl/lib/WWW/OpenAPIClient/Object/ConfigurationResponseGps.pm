...
#
package WWW::OpenAPIClient::Object::ConfigurationResponseGps;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'ConfigurationResponseGps',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'dyn_platform_model' => {
        datatype => 'GpsDynPlatformModel',
        base_name => 'dynPlatformModel',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'keep_on' => 'boolean',
    'sync_time' => 'boolean',
    'dyn_platform_model' => 'GpsDynPlatformModel'
} );

__PACKAGE__->attribute_map( {
    'keep_on' => 'keepOn',
    'sync_time' => 'syncTime',
    'dyn_platform_model' => 'dynPlatformModel'
} );
