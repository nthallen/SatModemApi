...
#
package WWW::OpenAPIClient::Object::ConfigurationResponse;
...
__PACKAGE__->method_documentation({
    ...
    'gps' => {
        datatype => 'ConfigurationResponseGps',
        base_name => 'gps',
        description => '',
        format => '',
        read_only => '',
    ...
    'ird' => {
        datatype => 'ConfigurationResponseIrd',
        base_name => 'ird',
        description => '',
        format => '',
        read_only => '',
    ...
    'outgoing_firewall' => {
        datatype => 'ConfigurationResponseOutgoingFirewall',
        base_name => 'outgoingFirewall',
        description => '',
        format => '',
        read_only => '',
            },
    'port_fwd' => {
        datatype => 'ConfigurationResponsePortFwd',
        base_name => 'portFwd',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    ...
    'dns' => 'DnsSettingsResponse',
    'eth' => 'EthSettingsResponse',
    'gps' => 'ConfigurationResponseGps',
    'wifi' => 'WiFiSettingsResponse',
    'ird' => 'ConfigurationResponseIrd',
    'outgoing_firewall' => 'ConfigurationResponseOutgoingFirewall',
    'port_fwd' => 'ConfigurationResponsePortFwd'
} );
...
__PACKAGE__->attribute_map( {
    ...
    'wifi' => 'wifi',
    'ird' => 'ird',
    'outgoing_firewall' => 'outgoingFirewall',
    'port_fwd' => 'portFwd'
} );
